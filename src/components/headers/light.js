...
export var PrimaryLink = tw(NavLink)`
  lg:mx-2
  px-8 py-3 rounded bg-primary-500 text-gray-100
  hocus:bg-primary-700 hocus:text-gray-200 focus:shadow-outline
  border-b-0
`;
PrimaryLink = tw(PrimaryLink)`shadow-raised lg:bg-primary-800 lg:hocus:bg-primary-700`;
...
export default ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
   ...
   */
  const defaultLinksAuthenticated = [
    <NavLinks key={1}>
  ...
  const defaultLinksNotAuthenticated = [
    <NavLinks key={1}>
      <NavLink href="mission">Our Mission</NavLink>
      <NavLink href="hiw">How It Works</NavLink>
      <NavLink href="pricing">Pricing</NavLink>
